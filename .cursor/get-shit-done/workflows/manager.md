...
```bash
INIT=$(node "/Users/tarnesty/Developer/personal/ploutizo/.cursor/get-shit-done/bin/gsd-tools.cjs" init manager)
```
...
Steps:
1. Read the plan-phase workflow: cat /Users/tarnesty/Developer/personal/ploutizo/.cursor/get-shit-done/workflows/plan-phase.md
2. Run: node \"/Users/tarnesty/Developer/personal/ploutizo/.cursor/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat /Users/tarnesty/Developer/personal/ploutizo/.cursor/get-shit-done/workflows/execute-phase.md
2. Run: node \"/Users/tarnesty/Developer/personal/ploutizo/.cursor/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
