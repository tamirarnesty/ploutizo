...
/** Mutually exclusive full-file outcome for one source row of an import set. */
export const IMPORT_ROW_OUTCOME_VALUES = [
  'created',
  'matched',
  'skipped',
  'invalid',
...
export type ImportRowOutcome = (typeof IMPORT_ROW_OUTCOME_VALUES)[number];
