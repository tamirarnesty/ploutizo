...
**Naming convention:** Schema variables and type exports are PascalCase.
When a type name conflicts with a component name, import with an alias: `import type { AccountForm as AccountFormType }`.
...
// Type conflicts with component name — import with alias
...
// import type alias because CategoryForm is also the component name
...
| `packages/validators/src/index.ts` | Add `AccountFormSchema`, `CategoryFormSchema`, `RuleFormSchema`, `HouseholdSettingsFormSchema` and their inferred types |
