...
| 007 | settlement-modal-recipient-flow | How should settlement modal prioritize prefilled recipient selection from Card Balances while keeping amount/source/date overrideable? | Synthesis (D): C + app primitives | settlement, modal, recipient-first, dashboard |
