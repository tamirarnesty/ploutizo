...
- Usage: Reference from command with `@/Users/tarnesty/Developer/personal/ploutizo/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/tarnesty/Developer/personal/ploutizo/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/tarnesty/Developer/personal/ploutizo/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
