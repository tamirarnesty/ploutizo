...
- **Global scope**: `/Users/tarnesty/Developer/personal/ploutizo/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tarnesty/Developer/personal/ploutizo/.claude/notes/`)
...
2. Glob `/Users/tarnesty/Developer/personal/ploutizo/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tarnesty/Developer/personal/ploutizo/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tarnesty/Developer/personal/ploutizo/.claude/notes/` — works in any directory
